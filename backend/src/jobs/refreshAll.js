...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var titles, _i, _a, t, prov;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, supabase.from('titles').select('id, tmdb_id, media_type')];
            case 1:
                titles = (_b.sent()).data;
                _i = 0, _a = titles;
                _b.label = 2;
            case 2:
                ...
                t = _a[_i];
                return [4 /*yield*/, (0, tmdb_js_1.tmdbProviders)(t.tmdb_id, t.media_type, process.env.WATCH_REGION)];
            case 3:
                prov = _b.sent();
            ...
            case 5:
                _b.sent(); // be kind to TMDB rate limit
                _b.label = 6;
            case 6:
                _i++;
                return [3 /*break*/, 2];
